...
def Create_Data_Set() :
	...
	sizes = [5, 10, 20, 50, 100, 1000, 10000, 100000]
	new = []
	for size in sizes:
		new = create_set(size)
...
if __name__ == "__main__" :
	files = ["Datafile_Size_5", "Datafile_Size_10", "Datafile_Size_20", "Datafile_Size_50"] #"Datafile_Size_100", "Datafile_Size_1000", "Datafile_Size_10000", "Datafile_Size_100000"]
	for i in range(5) :
		Create_Data_Set()
